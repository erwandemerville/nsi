...
!!! question "Informations"
    ...
    Si vous n'avez pas l'intention de le faire vous-même, <u>ne le faites pas du tout</u>.
    
    Énoncé en *PDF* : [DM1.pdf](dm1/DM1.pdf)
...
!!! tip "Exercice 1 - Vrai ou Faux ?"
    ...
    {% if exercices.premiere.bases_python.dm1 %}
...
!!! tip "Exercice 2"
    ...
    2. Voici 4 propositions, entourez celles qui sont **des expressions** et soulignez celles qui sont **des affectations** :
          ...
          4. a >= b
    {% if exercices.premiere.bases_python.dm1 %}
    Solution : **Expressions** (<span style="color:blue">en bleu</span>) et **affectations** (<span style="color:green">en vert</span>) :  
    <span style="color:green">a < b</span>  
    <span style="color:green">a != b</span>  
